        ...
        {step === 1 && <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 bg-white border border-gray-200 rounded-lg p-8">
              ...
              <p className="text-gray-600 text-sm mb-6">
                Fill out your contact and your project needs
              </p>
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" name="firstName" value={formData.firstName} onChange={handleInputChange} required className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-brand-teal focus:border-transparent ${errors.firstName ? 'border-red-500' : 'border-gray-300'}`} />
                  ...
                  <div>
                    ...
                    <input type="text" name="lastName" value={formData.lastName} onChange={handleInputChange} required className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-brand-teal focus:border-transparent ${errors.lastName ? 'border-red-500' : 'border-gray-300'}`} />
                ...
                <div>
                  ...
                  <input type="email" name="email" value={formData.email} onChange={handleInputChange} required className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-brand-teal focus:border-transparent ${errors.email ? 'border-red-500' : 'border-gray-300'}`} />
                ...
                <div>
                  ...
                  <input type="tel" name="phone" value={formData.phone} onChange={handleInputChange} required className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-brand-teal focus:border-transparent ${errors.phone ? 'border-red-500' : 'border-gray-300'}`} />
                ...
                <div>
                  ...
                  <input type="text" name="company" value={formData.company} onChange={handleInputChange} required className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-brand-teal focus:border-transparent ${errors.company ? 'border-red-500' : 'border-gray-300'}`} />
                ...
                <div>
                  ...
                  <select name="industry" value={formData.industry} onChange={handleInputChange} required className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-brand-teal focus:border-transparent ${errors.industry ? 'border-red-500' : 'border-gray-300'}`}>
        ...
        {step === 2 && <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 bg-white border border-gray-200 rounded-lg p-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-6">
                ...
                {errors.projectRequirements && <p className="text-red-500 text-xs mt-1">
              ...
              <div className="flex gap-4">
                ...
                <button onClick={handleSubmit} className="flex-1 bg-brand-teal text-white py-3 rounded-lg hover:bg-brand-teal-dark font-medium">
                  Continue to Payment
                </button>
              </div>
            </div>

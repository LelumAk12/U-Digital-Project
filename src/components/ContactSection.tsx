        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg">
              <div className="w-12 h-12 bg-gradient-to-br from-brand-teal to-brand-teal-dark rounded-lg flex items-center justify-center mb-4">
                <PhoneIcon className="w-6 h-6 text-white" />
              </div>
              <h4 className="font-bold text-brand-dark mb-2">Call Us</h4>
            ...
            <div className="bg-white p-6 rounded-lg">
              ...
              <h4 className="font-bold text-brand-dark mb-2">Email Us</h4>
            ...
            <div className="bg-white p-6 rounded-lg">
              ...
              <h4 className="font-bold text-brand-dark mb-2">Working Hours</h4>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white p-8 rounded-lg">
              <h4 className="text-xl font-bold text-brand-dark mb-6">
                Send us a Message
              </h4>
              ...
              <form className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="email" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-teal focus:border-transparent" />
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="tel" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-teal focus:border-transparent" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Service Required
                ...
                <div>
                  ...
                  <textarea rows={4} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-teal focus:border-transparent"></textarea>
                </div>
                <div className="text-sm text-gray-500 mb-4">
                  We respect your privacy and will never share your information
                  with third parties.
                </div>
                <button type="submit" className="w-full bg-brand-teal text-white px-8 py-3 rounded-lg hover:bg-brand-teal-dark font-medium">
                  Send Message
                </button>
              </form>
            </div>
